define(['application', 'kendoUi', 'kendoGridFa'], function (app) {
    app.register.directive('editContractStop', ['$compile', '$uibModal', 'messageService', function ($compile, $uibModal, messageService) {

        return {
            restrict: 'E',
            transclude: true,
            templateUrl: '/App/template/edit-contract-stop.html',
            scope: {
                contractstop: '=',
                //onsuccess: '=',
                open: '=',
