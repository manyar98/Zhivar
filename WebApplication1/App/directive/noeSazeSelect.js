define(['application', 'dataService'], function (app) {
    app.register.directive('noeSazeSelect', ['dataService', function (service) {
        return {
            restrict: 'E',
            transclude: true,
            templateUrl: "/App/template/noe-saze-select.html",
            scope: {
                filter: "=",
                text: "=?",
                eid: "=",
            ...
            link: function (scope, element, attrs) {
                ...
                scope.init = function () {
                    ...
                    service.getAll('/app/api/NoeSaze/GetAllByOrganId').then(function (data) {
                ...
                scope.submitNode = function () {
                    ...
                    service.addEntity("/app/api/NoeSaze/Add", scope.node).then(function (node) {
