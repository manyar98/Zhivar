define(['application', 'dataService'], function (app) {
    app.register.directive('goroheSazeSelect', ['dataService', function (service) {
        return {
            restrict: 'E',
            transclude: true,
            templateUrl: "/App/template/gorohe-saze-select.html",
            scope: {
                filter: "=",
                text: "=?",
                eid: "=",
            ...
            link: function (scope, element, attrs) {
                ...
                scope.init = function () {
                    ...
                    service.getAll('/app/api/GoroheSaze/GetAllByOrganId').then(function (data) {
                ...
                scope.submitNode = function () {
                   ...
                   // if (scope.tree.selected.tag && scope.node.Id === 0) scope.node.Parent = scope.tree.selected.tag;
                    ...
                    service.addEntity("/app/api/GoroheSaze/AddGoroheKala", scope.node).then(function (node) {
