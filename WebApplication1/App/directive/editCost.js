define(['application', 'dataService'], function (app) {
    app.register.directive('editCost', ['dataService', '$compile', function (Service, $compile) {
        return {
            restrict: 'E',
            transclude: true,
            templateUrl: "/App/template/edit-cost.html",
            scope: {
                item: '=',
                onsuccess: '=',
                open: '=',
            ...
            link: function (scope, element, attrs) {
                ...
                scope.getNewInventoryItem = function (defaultNode) {
                    ...
                    $.ajax({
                        ...
                        url: "/app/api/Cost/GetNewCostAccountObject",
                ...
                scope.getInventoryItem = function (id) {
                    ...
                    $.ajax({
                        type: "POST",
                        data: JSON.stringify(id),
                        url: "/app/api/Cost/GetCostAccountById",
                        contentType: "application/json"
                    }).done(function (res) {
                        var result = res.data;
                        scope.calling = false;
                ...
                scope.saveItem = function (next) {
                    ...
                    $.ajax({
                        ...
                        url: "/app/api/Cost/AddCostAccount",
                        contentType: "application/json"
                    }).done(function (res) {
