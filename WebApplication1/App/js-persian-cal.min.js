...
var me = function (a) { return Hesabfa.englishDigit(a); }
...
cE("a");e.className=c.btnClassName;e.href="#";if(!d)return;d.parentNode.insertBefore(e,d.nextSibling);var g=this;e.onclick=function(a){g.showHidePicker(a);return!1}}var f=this;d.onclick=function(a){f.showHidePicker(a);return!1};var h=this;d.onblur=function(){h.normalizeUserInput()};var k=this;addEvt(d,"keydown",function(a){k.keyDownHandler(a,k)});c.initialDate&&this.fillDateField(c.initialDate)};
AMIB.persianCalendar.prototype.showHidePicker=function(b){var a=this.inputID+"_pDatePicker",c;if(c=A$(a)){this.visible=false;if(c.parentNode.removeChild(c),document.onclick=this.oldDocumentOnClick,lastOpenPDatePicker=this.oldDocumentOnClick=!1,b=A$(lastOpenPDateMonthYearID))b.parentNode.removeChild(b),lastOpenPDateMonthYearID=!1}else if(!0===this.enabled){var d=this.input;c=cE("div");c.id=a;c.className=this.getOption("divPickerClassName");this.visible=true;this.createDateTable(c,me(d.value),me(d.value));document.body.appendChild(c);this.setMenuPos(c,
...
b.appendChild(d)};AMIB.persianCalendar.prototype.changePickerDate=function(b,a,c){var d;if(d=A$(this.inputID+"_pDatePicker"))b||(b=window.event),stopPropg(b),b=a.toString()+"/"+c.toString()+"/1",this.createDateTable(d,b,me(this.input.value))};
...
AMIB.persianCalendar.prototype.monthYearPickerClick=function(b,a,c){var d,e;if(d=A$(this.inputID+"_pDatePicker"))b||(b=window.event),stopPropg(b),(e=A$(lastOpenPDateMonthYearID))&&e.parentNode.removeChild(e),lastOpenPDateMonthYearID=!1,b=c.toString()+"/"+a.toString()+"/1",this.createDateTable(d,b,me(this.input.value))};
...
b[1].toString()),a=a.replace(/d/g,b[2].toString()),c=persian_to_jd(b[0],b[1],b[2]),a=a.replace(/JD/g,c),c=jd_to_gregorian(c),a=a.replace(/YYYY/g,zeroPad(c[0],4)),a=a.replace(/MM/g,zeroPad(c[1],2)),a=a.replace(/DD/g,zeroPad(c[2],2)),a=a.replace(/YY/g,zeroPad(c[0]%100,2)),a=a.replace(/M/g,c[1].toString()),a=a.replace(/D/g,c[2].toString()),A$(this.getOption("extraInputID")).value=a,A$(this.getOption("extraInputID")).dateChanged());fdef(this.getOption("onchange"))&&(this.getOption("onchange")(b.slice(0)))};
AMIB.persianCalendar.prototype.keyDownHandler=function(b,a){var c;b||(b=window.event);if(b.keyCode)c=b.keyCode;else if(b.which)c=b.which;else return!1;if(!(48<=c&&57>=c||96<=c&&105>=c||191===c||111===c||8===c||9===c||13===c||46===c||109===c||35===c||36===c||37===c||39===c))if(38===c||40===c){var d=isPersianDate(me(a.input.value));!1!==d&&(38===c?a.fillDateField(jd_to_persian(persian_to_jd(d[0],d[1],d[2])+1)):40===c&&a.fillDateField(jd_to_persian(persian_to_jd(d[0],d[1],d[2])-1)),a.input.select(),prvDef(b))}else b.ctrlKey||
prvDef(b)};
