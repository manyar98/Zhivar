...
function invoiceFactory(invoice, info) {
	...
	gr.drawText(r.left, r.top + 25, r.width, r.height, "تاریخ: " + invoice.DisplayDate, font, fontSize + fontX + "pt", "#000", "top", "left", false, false, false, true);
	n += 75;
	...
	if (invoice.InvoiceType !== 4 && (invoiceSettings.showVendorInfo || invoice.InvoiceType === 1 || invoice.InvoiceType === 3)) {
		...
		gr.drawRect(r.left, r.top + n, r.width, 90, "black", "1px", "solid", 5);
		gr.fillRect(r.width - 7, r.top + n + 1, 45, 88, "silver", "1px", 5);
	...
	if (info.itemCursor + 1 <= invoice.InvoiceItems.length) {    // اگر آیتمی باقیمانده بود جهت رسم
		...
		while (true) {
			...
			gr.drawText(r.width - 10, r.top + n, 50, r.height, item.RowNumber, font, rowFontSize, "black", "top", "center", isBold, false, false, true);
			...
			gr.drawLine(r.left, r.top + n + 30 + (des2Rows ? 25 : 0), r.width + 40, r.top + n + 30 + (des2Rows ? 25 : 0), "black", "1px", "solid");
			n += 40;
			if (des2Rows) n += 25;
		}
		...
		if (pageSize.name === "A4portrait") {
			gr.drawLine(r.width - 240, r.top + rowStart, r.width - 240, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.width - 290, r.top + rowStart, r.width - 290, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.width - 390, r.top + rowStart, r.width - 390, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.width - 490, r.top + rowStart, r.width - 490, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.width - 590, r.top + rowStart, r.width - 590, r.top + n - 10, "black", "1px", "solid");
		}
		else if (pageSize.name === "A4landscape") {
			gr.drawLine(r.left + 470, r.top + rowStart, r.left + 470, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 420, r.top + rowStart, r.left + 420, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 320, r.top + rowStart, r.left + 320, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 220, r.top + rowStart, r.left + 220, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 120, r.top + rowStart, r.left + 120, r.top + n - 10, "black", "1px", "solid");
		}
		else if (pageSize.name === "A5") {
			gr.drawLine(r.left + 255, r.top + rowStart, r.left + 255, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 200, r.top + rowStart, r.left + 200, r.top + n - 10, "black", "1px", "solid");
			gr.drawLine(r.left + 105, r.top + rowStart, r.left + 105, r.top + n - 10, "black", "1px", "solid");
		}
	...
	if (!reachPageEnd && !info.isSummaryPrinted && info.itemCursor + 1 > invoice.InvoiceItems.length) {
		if (r.top + n + 60 + nn <= r.height) {
			...
			if (invoiceSettings.showAmountInWords && invoiceSettings.showAmountInWords === true) {
				...
				gr.drawLine(r.width - 270, r.top + n + 25, r.width + 40, r.top + n + 25, "black", "1px", "solid");
				gr.drawLine(r.width - 270, r.top + n + 28, r.width + 40, r.top + n + 28, "black", "1px", "solid");
				n += 30;
			}
			...
			gr.drawLine(r.left, r.top + n, r.left + 270, r.top + n, "black", "1px", "solid");
			n += 10;
			...
			gr.drawLine(r.left, r.top + n + 25, r.left + 270, r.top + n + 25, "black", "1px", "solid");
			gr.drawLine(r.left, r.top + n + 28, r.left + 270, r.top + n + 28, "black", "1px", "solid");
	...
	if (!reachPageEnd && info.isSummaryPrinted && info.payments && info.payments.length > 0 && !info.isTransactionsPrinted && invoiceSettings.showTransactions) {
		...
		if (r.top + n + 60 <= r.height) {
			...
			gr.fillRect(r.width - 40, r.top + n, 80, 23, "#dcdcdc", "1px", 0);
...
function printInvoice(invoice, settings, totalDiscount, totalTax, payments, business, currency) {
	...
	var wnd = settings.pageSize === "8cm" ? window.open("/dashboard/reports/invoice8cm.html?ver=1.2.9.1") : window.open("");
...
function getInvoicePrintImage_A4Landscape2(invoice, info) {
	...
	if (invoice.InvoiceType !== 4 && (invoiceSettings.showVendorInfo || invoice.InvoiceType === 1 || invoice.InvoiceType === 3)) {
		...
		var k1 = 310;
		for (var j = 0; j < 12; j++) {
			gr.drawRect(r.left + k1, r.top + n + 5, 20, 25, "black", "1px", "solid", 0);
		...
		k1 = 350;
		for (var j = 0; j < 10; j++) {
			gr.drawRect(r.left + k1, r.top + n + 35, 20, 25, "black", "1px", "solid", 0);
	...
	var rowStart = n + 30;
	if (info.itemCursor + 1 <= invoice.InvoiceItems.length) {    // اگر آیتمی باقیمانده بود جهت رسم
		gr.drawRect(r.left, r.top + n, r.width, 30, "black", "1px", "solid", 0);
		...
		gr.drawLine(r.width + 10, r.top + rowStart, r.width + 10, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.width - 40, r.top + rowStart, r.width - 40, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 570, r.top + rowStart, r.left + 570, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 520, r.top + rowStart, r.left + 520, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 420, r.top + rowStart, r.left + 420, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 320, r.top + rowStart, r.left + 320, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 220, r.top + rowStart, r.left + 220, r.top + n - 10, "black", "1px", "solid");
		gr.drawLine(r.left + 120, r.top + rowStart, r.left + 120, r.top + n - 10, "black", "1px", "solid");
