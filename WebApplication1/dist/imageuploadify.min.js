    ...
    function ($, window, document, undefined) {
        ...
        const compareMimeType = (mimeTypes, fileType, formatFile) => {
            ...
            for (let index = 1; index < mimeTypes.length; index += 3){
                ...
                else if (mimeTypes[index + 1] && mimeTypes[index + 1] != "*" && fileType.search(new RegExp(mimeType[index + 1])) != -1) { return true; }
            ...
            if (!isGenerate)
            {
                ...
                this.each(function () {
                    ...
                    let accept = $(self).attr("accept") ? $(self).attr("accept").replace(/\s/g, "").split(",") : null; let result = []; accept.forEach((item) => {
                        let regexp;
                        if (item.search(/\//) != -1) { regexp = new RegExp("([A-Za-z-.]*)\/([A-Za-z-*.]*)", "g"); }
                    ...
                    let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><span class='imageuploadify-message'>عکس های خود را بکشید و رها کنید</span><button type="button"class="btn btn-default">یا فایل خود را انتخاب کنید</button></div></div>`);
                    ...
                    const readingFile = (id, file) => {
                        ...
                        if (file.type && file.type.search(/image/) != -1) {
                            fReader.onloadend = function (e) {
                                ...
                                totalFiles.push({ id: id, file: file, src: e.target.result });
