...
namespace Zhivar.Web.Controllers.Common
{
    public class BussinessController : NewApiControllerBaseAsync<Bussiness, BussinessVM>
    {
        ...
        public virtual async Task<HttpResponseMessage> GetCurrentUserAndBusinesses()
        {
            ...
            var person = await personRule.FindAsync(1);
            ...
            var bussinesses = await bussinessSiteRule.GetAllByOrganIdAsync(organId);
            ...
            return Request.CreateResponse(HttpStatusCode.OK, new { resultCode = (int)ZhivarEnums.ResultCode.Successful, data = responseCurrentUserAndBusinesses });
        }
        ...
        public async Task<HttpResponseMessage> Delete([FromBody]List<Bussiness> bussinesss)
        {
            ...
            return Request.CreateResponse(HttpStatusCode.OK, new { resultCode = (int)ZhivarEnums.ResultCode.Successful, data = bussinesss });
        }
        ...
        {
            return Request.CreateResponse(HttpStatusCode.OK, new { resultCode = (int)ZhivarEnums.ResultCode.Successful, data = bussiness });
        }
        }
