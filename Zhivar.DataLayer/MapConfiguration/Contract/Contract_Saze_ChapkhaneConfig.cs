...
{
    public partial class Contract_Saze_ChapkhaneConfig : BaseEntityTypeConfig<DomainClasses.Contract.Contract_Saze_Chapkhane>
    {
        public Contract_Saze_ChapkhaneConfig()
        {
            ToTable("Contract_Saze_Chapkhane");
